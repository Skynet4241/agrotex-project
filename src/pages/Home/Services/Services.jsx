          ...
          <Container>
            ...
            <ServicesBlock>
              ...
              <ServicesInfoBlockText>
                ...
                <br /> Забезпечуючи безперебійну роботу обладнання клієнтів, ми
                оперативно та професійно діагностуємо та ремонтуємо техніку,
                навіть безпосередньо на об'єкті. <br /> Ми команда
                висококваліфікованих фахівців, що поєднує в собі гнучкість
                рішень, навчання і мобільність, завжди готова задовольнити
                потреби клієнтів та забезпечити надійну співпрацю.
              </ServicesInfoBlockText>
            </ServicesBlock>
            <ServicesInfoBlockButton>
              Переглянути послуги{' '}
